    ...
    <nav className="sticky top-0 z-50 bg-darkBg/80 backdrop-blur-md border-b border-darkBorder px-6 py-4 flex items-center justify-between transition-all">
      ...
      {!location.pathname.startsWith('/admin') && (
        <div className="hidden md:flex items-center space-x-8 text-xs font-bold uppercase tracking-wider">
          ...
          <Link
            to="/web-development"
            className={`transition-colors ${isActive('/web-development') ? 'text-accentBlue' : 'text-slate-400 hover:text-slate-200'}`}
          >
            Web Dev
          </Link>
          <Link
          ...
          <Link
            to="/games"
            className={`transition-colors ${isActive('/games') ? 'text-accentBlue' : 'text-slate-400 hover:text-slate-200'}`}
          >
            Games
          </Link>
          <Link
            to="/companies"
            className={`transition-colors ${isActive('/companies') ? 'text-accentBlue' : 'text-slate-400 hover:text-slate-200'}`}
          >
            Companies
          </Link>
          <Link
          ...
          {!location.pathname.startsWith('/admin') ? (
            <>
              ...
              <Link
                to="/web-development"
                onClick={() => setMobileMenuOpen(false)}
                className={`p-2 rounded hover:bg-darkBg/60 transition-colors ${isActive('/web-development') ? 'text-accentBlue' : 'text-slate-300'}`}
              >
                Web Dev
              </Link>
              <Link
              ...
              <Link
                to="/games"
                onClick={() => setMobileMenuOpen(false)}
                className={`p-2 rounded hover:bg-darkBg/60 transition-colors ${isActive('/games') ? 'text-accentBlue' : 'text-slate-300'}`}
              >
                Games
              </Link>
              <Link
                to="/companies"
                onClick={() => setMobileMenuOpen(false)}
                className={`p-2 rounded hover:bg-darkBg/60 transition-colors ${isActive('/companies') ? 'text-accentBlue' : 'text-slate-300'}`}
              >
                Companies
              </Link>
              <Link
